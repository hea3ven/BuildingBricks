...
public class BlockCorner extends BlockBuildingBricksNonSolid {
	...
	private static final PropertyEnum ROTATION = PropertyEnum
			.create("rotation", EnumRotation.class);
	...
	public static EnumBlockHalf getStateHalf(IBlockState state) {
		return (EnumBlockHalf) state.getValue(HALF);
	}

	public static IBlockState setStateHalf(IBlockState state, EnumBlockHalf half) {
		return state.withProperty(HALF, half);
	}

	public static EnumRotation getStateRotation(IBlockState state) {
		return (EnumRotation) state.getValue(ROTATION);
	}

	public static IBlockState setStateRotation(IBlockState state, EnumRotation rotation) {
